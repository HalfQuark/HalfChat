...
public class ChatCommand implements ConfigurationSerializable
{
    ...
    public ChatCommand(ArrayList<String> aliases, String permission, String format, int radius)
    {
    ...
    public ChatCommand(Map<String, Object> serializedConfigCommand)
    {
